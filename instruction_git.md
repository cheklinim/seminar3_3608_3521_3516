...
Для того, чтобы совершить переход локальной копии, после внесенных изменений, в Интернет, нужно ввести команду:

    git push

Для того, чтобы внедрить изменения из репозитория с Интернета в локальную, нужно ввести команду:
