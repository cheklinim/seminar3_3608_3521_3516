...
Далее после создания своей версии чужого удаленного репозитори, можно подать запрос на включение в проект.

Для этого готовый репозиторий помещаем на хостинге и нажимаем на кнопку:

    pull requests

Автор проекта оценивает предлагаемые изменения и при согласии присоединяет данную версию.