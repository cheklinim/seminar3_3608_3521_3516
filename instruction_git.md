...
Для отправки локальной ветки на удаленный репозиторий, нужно ввести команду:

    git push

### Получение изменений из удаленного репозитория

Для получения изменений из указанного удаленного репозитория, нужно ввести команду:

    git push

### Создание записи о новом подключении к удаленному репозиторию

Для создания записи о новом подключении к удаленному репозиторию, нужно ввести команду:
