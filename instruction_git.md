...
Чтобы отправить запрос на изменение автору проекта, необходимо создать Pull Request в GitHub. Копируем проект, создаем отдельную ветку, сохраняем изменения и выполняем команду
