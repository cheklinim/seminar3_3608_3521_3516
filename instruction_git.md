...
Чтобы взять для использования чужой репозиторий, нужно на гит хабе найти нужный репозиторий, нажать на кнопку fork, называть как хочется, выбрать забирать ли только втеку мастер, 
или забрать и другие, далее в получившемся скопированном репозитории, копируем ссылку через кнопку code.
Далее создаем пустую папку, открываем пустую папку в VSC, далее используем команду:

    git clone скопированная ссылка

### Чтобы можно было начать работать с полученным репозиторим нужно либо ввести команду:

    cd название файла

Либо в VSC нажать по папке правой кнопке мыши, и нажать кнопку "открыть во встроенном терминале"

("Правила хорошего тона" - если собираетесь предлогать изменения владельцу репозитория, создайте отдельную ветку в клонированном репозитории, и работайте в этой ветке)