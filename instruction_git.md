...
Для того что бы взять удаленный репозиторий необходимо ввести команду:
...
Для отправки изменений локального рекпозитория в удаленный необходимо ввести 
...
## Клонирование удаленной репозитории

Копировать внешний (Удаленной) репозиторий на свой ПК можно командой: 
...
Для того что бы скачать все из текущей репозитории и автоматичемки сделать merge с нашей версией используется команда:
